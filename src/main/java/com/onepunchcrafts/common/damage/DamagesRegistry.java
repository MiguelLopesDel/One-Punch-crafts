...
public class DamagesRegistry {
    ...
    public static ResourceKey<DamageType> SERIOUS_PUNCH_SECOND = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(MODID, "serious_punch_second_damage"));
