...
import com.onepunchcrafts.v3.api.combat.DamageInterceptor;
import com.onepunchcrafts.v3.api.combat.DamageObserver;
import com.onepunchcrafts.v3.api.combat.DamageStage;
...
public final class DamagePipeline {
    ...
    public DamageApplier.ApplyResult execute(DamageContext original, DamageApplier applier) {
        ...
        boolean outcomeDenied = current.spec().tier() == com.onepunchcrafts.v3.api.combat.DamageTier.SERIOUS
